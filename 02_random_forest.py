...
for i in tqdm(range(1,21)):
    ### Build Regressors
    regr_1 = RandomForestRegressor(max_depth=i,min_samples_split=10,min_samples_leaf=5,n_estimators=100,random_state=42)
    ### Fit Regressors
...
### Build Regressors
regr_1 = RandomForestRegressor(max_depth=int(df_scores["max_depth"]),min_samples_split=10,min_samples_leaf=5,random_state=42)
### Fit Regressors
regr_1.fit(x_train, y_train)
# %%
# Summary
